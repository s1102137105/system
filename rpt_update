...
<head>
    ...
    <SCRIPT type="text/javascript">
        function radiocheck()
        {
            ...
            {
                CheckFlag = (CheckFlag || a.elements[i].checked);
            }
            if(!CheckFlag)
            {
                alert("請選擇欲修改項目!");
...
?>
                <form action="rpt_updatepage.php" method="post" name="a" onsubmit="return radiocheck()">
        <table>
    <tbody>
    <tr>
    <td></td>
    ...
    <tr>
        <td><input type="radio" name="Receipt_ID" value="<?php echo $row['Receipt_ID'];?>"/></td>
