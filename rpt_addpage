<?php
    ...
    try{
        ...
        $sql1="INSERT INTO `db_receipt`(`Stu_ID`, `Emp_ID`, `Receipt_Project`, `Receipt_Money`, `Receipt_Date`) VALUES ('$Student_ID','$Employee_ID','$Receipt_Project','$Receipt_Money','$Receipt_Date')";
